...
export const listStalledOrdersSchema = {
  threshold_hours: z
    ...
    .optional()
    .describe(
      'Minimum age of the order in hours before it is considered stalled. ' +
...
export async function listStalledOrdersHandler(
  args: z.infer<z.ZodObject<typeof listStalledOrdersSchema>>
) {
